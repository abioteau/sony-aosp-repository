...
cd $AOSP_WORKSPACE
~/bin/repo init -u $AOSP_MIRROR_URL/platform/manifest.git --repo-url $AOSP_MIRROR_URL/git-repo.git -b android-6.0.1_r77
...
~/bin/repo status
~/bin/repo forall -p -c git log --oneline android-6.0.1_r77..$GIT_BRANCH
