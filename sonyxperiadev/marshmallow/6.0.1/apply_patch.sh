...
git cherry-pick -n 48f57ad4f470ebcb71ac10df4e5e0953a6cfacd8 && export GIT_COMMITTER_DATE="$(git log -1 --format="%ad" 48f57ad4f470ebcb71ac10df4e5e0953a6cfacd8)" && git commit --no-edit --author "$(git log -1 --format="%an <%ae>" 48f57ad4f470ebcb71ac10df4e5e0953a6cfacd8)" --date "$(git log -1 --format="%ad" 48f57ad4f470ebcb71ac10df4e5e0953a6cfacd8)" && unset GIT_COMMITTER_DATE
