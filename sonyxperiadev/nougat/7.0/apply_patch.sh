...
cd $AOSP_WORKSPACE
~/bin/repo init -u $AOSP_MIRROR_URL/platform/manifest.git --repo-url $AOSP_MIRROR_URL/git-repo.git -b android-7.0.0_r17
...
~/bin/repo status
~/bin/repo forall -p -c git log --oneline android-7.0.0_r17..$GIT_BRANCH
