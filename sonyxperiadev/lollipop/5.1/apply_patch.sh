...
git am --committer-date-is-author-date `ls $ROOTDIR/sonyxperiadev/patches/platform/hardware/qcom/audio/refs/changes/41/166941/1/*.patch`
git am --committer-date-is-author-date `ls $ROOTDIR/sonyxperiadev/patches/platform/hardware/qcom/audio/refs/changes/40/166940/1/*.patch`
...
git am --committer-date-is-author-date `ls $ROOTDIR/sonyxperiadev/patches/platform/external/libxml2/refs/changes/20/201520/1/*.patch`
cd ../../hardware/libhardware && git checkout -b $GIT_BRANCH
git am --committer-date-is-author-date `ls $ROOTDIR/sonyxperiadev/patches/platform/hardware/libhardware/refs/changes/21/103221/2/*.patch`
cd ../broadcom/libbt && git checkout -b $GIT_BRANCH
git am --committer-date-is-author-date `ls $ROOTDIR/sonyxperiadev/patches/platform/hardware/broadcom/libbt/refs/changes/13/154813/1/*.patch`
