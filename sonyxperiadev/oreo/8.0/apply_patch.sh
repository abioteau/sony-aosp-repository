...
git cherry-pick -n e28f4e2acfcca00766080d294daa75ae2efb5853 && export GIT_COMMITTER_DATE="$(git log -1 --format="%ad" e28f4e2acfcca00766080d294daa75ae2efb5853)" && git commit --no-edit --author "$(git log -1 --format="%an <%ae>" e28f4e2acfcca00766080d294daa75ae2efb5853)" --date "$(git log -1 --format="%ad" e28f4e2acfcca00766080d294daa75ae2efb5853)" && unset GIT_COMMITTER_DATE
